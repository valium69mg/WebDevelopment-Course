...
app.post("/submit", (req, res) => {
  ...
  const randIntAdj = Math.floor(Math.random() * adj.length);
  const randIntNoun = Math.floor(Math.random() * noun.length);
  const randomAdj = adj[randIntAdj];
  const randomNoun = noun[randIntNoun];
